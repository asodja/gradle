...
class ConstantToClassMappingMergerTest extends Specification {
    ...
    def "maps new class-to-constant mapping to expected constant-to-class mapping if previous was null"() {
        ...
        then:
        mapping.getDependentClasses("d".hashCode()) == ["a"] as Set
        mapping.getDependentClasses("e".hashCode()) == ["a", "b"] as Set
        mapping.getDependentClasses("f".hashCode()) == ["a", "b"] as Set
    ...
    def "merges new class-to-constant to constant-to-class mapping with previous"() {
        ...
        mapping.getDependentClasses("e".hashCode()) == ["a", "b"] as Set
        mapping.getDependentClasses("f".hashCode()) == ["a", "b"] as Set
        mapping.getDependentClasses("g".hashCode()) == ["c"] as Set
    ...
    def "removes all removed classes from constant-to-class mapping on merge"() {
        ...
        then:
        mapping.getDependentClasses("d".hashCode()).isEmpty()
        mapping.getDependentClasses("e".hashCode()) == ["b"] as Set
        mapping.getDependentClasses("f".hashCode()) == ["b"] as Set
    ...
    def "removes all classes with empty constant dependencies from constant-to-class mapping on merge"() {
        ...
        then:
        mapping.getDependentClasses("d".hashCode()) == [] as Set
        mapping.getDependentClasses("e".hashCode()) == ["b"] as Set
        mapping.getDependentClasses("f".hashCode()) == ["b", "c"] as Set
        mapping.getClassNames().size() == 2
